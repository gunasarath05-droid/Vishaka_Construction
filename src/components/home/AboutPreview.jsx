  ...
  return (
    <section className="py-12 md:py-24 lg:py-24 bg-white relative overflow-hidden" id="about">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden select-none">
        ...
        <span className="absolute top-[10%] -left-[5%] text-[20vw] font-black text-slate-50 opacity-[0.4] tracking-tighter leading-none select-none">
          LEGACY
        </span>
          ...
          <div className="lg:col-span-6 relative pb-16 sm:pb-20 lg:pb-0">
            ...
            >
              ...
              <div className="relative rounded-[2rem] sm:rounded-[3rem] overflow-hidden shadow-[0_30px_80px_-20px_rgba(0,0,0,0.15)] border-[8px] sm:border-[12px] border-white bg-slate-100 aspect-[4/5] lg:aspect-[4/4.5]">
                ...
                {/* Image Overlay HUD */}
                <div className="absolute top-8 left-8 flex items-center space-x-3 bg-black/40 backdrop-blur-md px-4 py-2 rounded-full border border-white/20">
                  <Activity size={12} className="text-teal-400 animate-pulse" />
                  <span className="text-[10px] font-black text-white uppercase tracking-widest">Live Site Data</span>
                </div>
              </div>
              ...
              >
                <div className="flex items-center space-x-3 mb-6">
                  ...
                  <span className="text-[10px] font-black text-teal-400 uppercase tracking-[0.4em]">Established 2008</span>
                </div>
                ...
                <div className="flex items-end space-x-2 mb-4">
                  ...
                  <p className="text-2xl font-bold text-teal-500 mb-2">+</p>
                </div>
                <p className="text-xs text-slate-400 uppercase tracking-widest font-black leading-relaxed">
                ...
                <div className="mt-8 pt-6 border-t border-white/5 flex items-center justify-between">
                  <div className="flex flex-col">
                    <span className="text-[8px] font-bold text-slate-500 uppercase tracking-widest mb-1">HQ Location</span>
                    <div className="flex items-center space-x-1">
                      <MapPin size={10} className="text-teal-400" />
                      <span className="text-[10px] font-bold">Chennai, IN</span>
                    </div>
                  </div>
                  <div className="flex flex-col items-end">
                    <span className="text-[8px] font-bold text-slate-500 uppercase tracking-widest mb-1">Status</span>
                    <span className="text-[10px] font-black text-teal-400">CORE_ACTIVE</span>
                  </div>
                </div>
              </motion.div>
          ...
          <div className="lg:col-span-6 relative z-10">
            ...
            >
              <motion.div variants={itemVariants} className="flex items-center space-x-4 mb-8">
                <span className="text-teal-600 font-bold text-xs tracking-[0.6em] uppercase">Who We Are</span>
              ...
              <motion.p variants={itemVariants} className="text-lg text-slate-500 mb-10 leading-relaxed max-w-xl">
              ...
              <motion.div variants={itemVariants} className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
                {[
                  ...
                  <div key={i} className="flex items-center space-x-4 group">
                    <div className="w-10 h-10 rounded-2xl bg-teal-50 flex items-center justify-center transition-all duration-300 group-hover:bg-slate-900 group-hover:text-white shadow-sm">
                      <item.icon size={18} className="text-teal-600 group-hover:text-teal-400" />
                    </div>
                    <span className="text-sm text-slate-700 font-bold">{item.text}</span>
                  </div>
                ))}
              </motion.div>

              <motion.div variants={itemVariants} className="flex flex-col sm:flex-row items-center space-y-6 sm:space-y-0 sm:space-x-8">
                <motion.button
                  onClick={() => navigate('/about')}
                  whileHover={{ scale: 1.02 }}
                  whileTap={{ scale: 0.98 }}
                  className="w-full sm:w-auto bg-slate-900 text-white px-10 py-5 rounded-[2rem] font-black text-sm uppercase tracking-widest shadow-2xl hover:bg-teal-600 transition-all duration-500 flex items-center justify-center"
                >
                  Our Full Story
