...
const CTASection = () => {
    return (
        <section className="relative min-h-[700px] flex items-center overflow-hidden ">
            ...
            <div className="max-w-[1600px] mx-auto px-4 md:px-12 relative z-10 w-full py-32 md:py-48">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24 items-center">
                    ...
                    <div className="lg:col-span-9">
                        ...
                        >
                            <div className="bg-white/30 backdrop-blur-xl rounded-[2.5rem] p-10 md:p-12 border border-white/40 shadow-xl">
